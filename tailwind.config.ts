...
const config: Config = {
  content: [
    ...
    "./node_modules/@nextui-org/theme/dist/components/(button|card|checkbox|chip|code|image|input|kbd|link|listbox|navbar|select|skeleton|snippet|toggle|tabs|popover|ripple|spinner|divider|scroll-shadow).js",
  ],
  theme: {
    extend: {
      colors: {
